...
func void Use_StonePlate()
{
	...
	else // (C_SCHasStPlSkill() == TRUE)
	{
		if (StoneplateItem == StrStonePlate)
		{
			...
			if (StoneplateLevel == 1)
			{
				B_RaiseAttribute_Bonus_Independent(self, ATR_STRENGTH, STR_StPlLevel1);
				concatText = ConcatStrings(concatText, IntToString(STR_StPlLevel1));
				B_Say(self, self, "STONEPLATE_1");
			}
			else if (StoneplateLevel == 2)
			{
				B_RaiseAttribute_Bonus_Independent(self, ATR_STRENGTH, STR_StPlLevel2);
				concatText = ConcatStrings(concatText, IntToString(STR_StPlLevel2));
				B_Say(self, self, "STONEPLATE_2");
			}
			else if (StoneplateLevel == 3)
			{
				B_RaiseAttribute_Bonus_Independent(self, ATR_STRENGTH, STR_StPlLevel3);
		...
		else if (StoneplateItem == DexStonePlate)
		{
			...
			if (StoneplateLevel == 1)
			{
				B_RaiseAttribute_Bonus_Independent(self, ATR_DEXTERITY, DEX_StPlLevel1);
				concatText = ConcatStrings(concatText, IntToString(DEX_StPlLevel1));
				B_Say(self, self, "STONEPLATE_1");
			}
			else if (StoneplateLevel == 2)
			{
				B_RaiseAttribute_Bonus_Independent(self, ATR_DEXTERITY, DEX_StPlLevel2);
				concatText = ConcatStrings(concatText, IntToString(DEX_StPlLevel2));
				B_Say(self, self, "STONEPLATE_2");
			}
			else if (StoneplateLevel == 3)
			{
				B_RaiseAttribute_Bonus_Independent(self, ATR_DEXTERITY, DEX_StPlLevel3);
		...
		else if (StoneplateItem == HitPointStonePlate)
		{
			...
			if (StoneplateLevel == 1)
			{
				B_RaiseAttribute_Bonus_Independent(self, ATR_HITPOINTS_MAX, HPMax_StPlLevel1);
			...
			{
				B_RaiseAttribute_Bonus_Independent(self, ATR_HITPOINTS_MAX, HPMax_StPlLevel2);
			...
			{
				B_RaiseAttribute_Bonus_Independent(self, ATR_HITPOINTS_MAX, HPMax_StPlLevel3);
		...
		else if (StoneplateItem == ManaStonePlate)
		{
			...
			if (StoneplateLevel == 1)
			{
				B_RaiseAttribute_Bonus_Independent(self, ATR_MANA_MAX, ManaMax_StPlLevel1);
			...
			{
				B_RaiseAttribute_Bonus_Independent(self, ATR_MANA_MAX, ManaMax_StPlLevel2);
			...
			{
				B_RaiseAttribute_Bonus_Independent(self, ATR_MANA_MAX, ManaMax_StPlLevel3);
