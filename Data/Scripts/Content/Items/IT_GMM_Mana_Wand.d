...
func int  PC_PrayShrine_Bless_Staff_Condition()
{
	...
	|| ((Npc_HasItems (hero,ItMW_GMM_Stab_02_Regen_V1) >= 1))
	|| ((Npc_HasItems (hero,ItMW_GMM_Stab_03_Eff_V1) >= 1))
	|| ((Npc_HasItems (hero,ItMW_GMM_Stab_04_Summon_V1) >= 1))
	
	|| ((Npc_HasItems (hero,ItMW_GMM_Stab_01_Mana_V2) >= 1))
	|| ((Npc_HasItems (hero,ItMW_GMM_Stab_02_Regen_V2) >= 1))
	|| ((Npc_HasItems (hero,ItMW_GMM_Stab_03_Eff_V2) >= 1))
	|| ((Npc_HasItems (hero,ItMW_GMM_Stab_04_Summon_V2) >= 1))
