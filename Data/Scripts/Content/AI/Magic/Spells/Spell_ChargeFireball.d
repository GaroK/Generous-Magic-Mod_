...
{
	if (self.attribute[ATR_MANA]<C_CheckManaCost(self,STEP_ChargeFireball)) 
	{
		return SPL_DONTINVEST;	
	};

	if (manaInvested <= C_CheckManaCost(self,STEP_ChargeFireball)*1)
	{
		self.aivar[AIV_SpellLevel] = 1; //Start mit Level 1
		return SPL_STATUS_CANINVEST_NO_MANADEC;
	}
	else if (manaInvested > (C_CheckManaCost(self,STEP_ChargeFireball)*1))
	&& (self.aivar[AIV_SpellLevel] <= 1)
	{
		self.attribute[ATR_MANA] = (self.attribute[ATR_MANA] - C_CheckManaCost(self,STEP_ChargeFireball));
	...
	else if (manaInvested > (C_CheckManaCost(self,STEP_ChargeFireball)*2))
	&& (self.aivar[AIV_SpellLevel] <= 2)
	{
		self.attribute[ATR_MANA] = (self.attribute[ATR_MANA] - C_CheckManaCost(self,STEP_ChargeFireball));
	...
	else if (manaInvested > (C_CheckManaCost(self,STEP_ChargeFireball)*3))
	&& (self.aivar[AIV_SpellLevel] <= 3)
	{
		self.attribute[ATR_MANA] = (self.attribute[ATR_MANA] - C_CheckManaCost(self,STEP_ChargeFireball));
